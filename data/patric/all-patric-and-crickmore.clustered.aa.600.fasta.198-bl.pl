...
foreach $id (@ids) {
  ...
  if (50) {
    $cmd = `blastp -outfmt 6 -db ./all-patric-and-crickmore.clustered.aa.600.fasta.198 -seg yes -evalue 0.000001 -max_target_seqs 100000 -num_threads 1 -query all-patric-and-crickmore.clustered.aa.600.fasta-seq/$id -out all-patric-and-crickmore.clustered.aa.600.fasta-bl/$id`;
    ...
    $cmd = `blastp -outfmt 6 -db ./all-patric-and-crickmore.clustered.aa.600.fasta.198 -seg yes -evalue 0.000001 -max_target_seqs 100000 -num_threads 1 -query all-patric-and-crickmore.clustered.aa.600.fasta-seq/$id | ../../scripts/cdhit/psi-cd-hit/psi-cd-hit.pl -J parse_blout all-patric-and-crickmore.clustered.aa.600.fasta-bl/$id -c 0.45 -ce -1 -aS 0 -aL 0 -G 1 -prog blastp -bs 1`;
  }
  else {
    $cmd = `blastp -outfmt 6 -db ./all-patric-and-crickmore.clustered.aa.600.fasta.198 -seg yes -evalue 0.000001 -max_target_seqs 100000 -num_threads 1 -query all-patric-and-crickmore.clustered.aa.600.fasta-seq/$id -out all-patric-and-crickmore.clustered.aa.600.fasta-bl/$id`;
